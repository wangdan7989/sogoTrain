# -*- coding: UTF-8 -*-
import jieba
def partciple_train(text_path):
   file_train = open(text_path, encoding="utf-8")                       #分词函数
   #file_train = open("user_tag_query.2W.TRAIN", encoding="utf-8") #训练集文本
   ...
   for line in contents:
     ...
     # names=[test_age,test_education,test_gender]
     for name in names:
